...
namespace VocabAid_WP
{
    ...
    public sealed partial class App : Application
    {
        ...
        public static SQLiteWinRT.Database db;
        ...
        public App()
        {
            ...
            //sqliteConn = new SQLiteConnection("MainDB.db");
        }
        ...
        {
            db = new SQLiteWinRT.Database(ApplicationData.Current.LocalFolder, "MainDB.db");
            try
            {
                await db.OpenAsync();
                DBLoaded.Set();
